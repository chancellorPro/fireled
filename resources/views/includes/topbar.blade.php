...
{{--                <img src="./logo.png" style="margin: -10px 0 0 20px;height: 45px;">--}}
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a data-toggle="tooltip" data-placement="top" title="{{ __('Logout') }}" href="{{ route('admin.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
